        ...
        <div className="mc-card-elevated">
          ...
          {!hasGames ? (
            <div className="text-center py-10">
              ...
              <p className="font-bold mc-text-primary mb-1">No positions yet</p>
              <p className="text-sm mc-text-dim">Start by making your first deposit in a game plan.</p>
            </div>
          ) : (
            <div className="space-y-3">
              {games!.map((game) => {
                ...
                return (
                  <div key={game.id.toString()} className={`mc-card ${accent} p-4`}>
